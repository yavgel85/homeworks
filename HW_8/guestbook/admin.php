...
<html lang="ru">
	...
	<body>
		...
		<form method="post" action="">
		  <label>
		    <span>Логин</span>
		    <input type="text" name="name" pattern=".{3,}" required title="Введите не менее 3 символов." autocomplete="off">
		  </label><br>

		  <label>
		    <span>Пароль</span>
		    <input type="password" name="pass" pattern=".{3,}" required title="Введите не менее 3 символов." autocomplete="off">
		  </label><br>		  
